...
"use strict";
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _requests_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./requests.js */ \"./src/js/requests.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ \"./src/js/utils.js\");\n/* harmony import */ var _pool__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pool */ \"./src/js/pool.js\");\nvar __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_utils__WEBPACK_IMPORTED_MODULE_1__, _pool__WEBPACK_IMPORTED_MODULE_2__]);\n([_utils__WEBPACK_IMPORTED_MODULE_1__, _pool__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);\n\n\n\n\nconst { notify, watch } = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.createEventListener)();\n\nlet protocol = 'ws:';\nif (document.location.protocol === 'https:') {\n  protocol = 'wss:';\n}\nconst pool = (0,_pool__WEBPACK_IMPORTED_MODULE_2__.createPool)(`${protocol}//${document.location.host}/ws`);\n\nwindow.pool = pool;\n\nconst client = {\n  send: async (msg) => {\n    // eslint-disable-next-line no-console\n    //console.log('send', msg);\n    const raw = JSON.stringify(msg);\n    await pool.send(raw);\n  },\n  on: (ev, cb) => {\n    watch(ev, cb);\n    return client;\n  },\n};\n\npool.onOpen(() => notify('con:open', client));\npool.onClose(() => notify('con:close', client));\npool.onError(() => notify('con:error', client));\npool.onPacket((raw) => {\n  try {\n    const msg = JSON.parse(raw.data);\n    notify('packet', msg);\n    // eslint-disable-next-line no-console\n    //console.log('recv', msg);\n    if(msg.priv) console.log('recv', msg);\n    if (msg.resp) notify('resp', client, msg);\n    else if (msg.op) notify(`op:${msg.op.type}`, client, msg);\n    else  notify('message', client, msg);\n  } catch (err) {\n    // eslint-disable-next-line no-console\n    console.error(err, raw);\n    notify('packet:error', client, raw, err);\n  }\n});\n\n(0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.initRequests)(client);\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (client);\n\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } });\n\n//# sourceURL=webpack://quack/./src/js/client.js?");
...
"use strict";
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Input\": () => (/* binding */ Input)\n/* harmony export */ });\n/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils.js */ \"./src/js/utils.js\");\n/* harmony import */ var _formatter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../formatter.js */ \"./src/js/formatter.js\");\n/* harmony import */ var _info_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./info.js */ \"./src/js/components/info.js\");\n/* harmony import */ var _services_messages_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/messages.js */ \"./src/js/services/messages.js\");\n/* harmony import */ var _services_typing__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/typing */ \"./src/js/services/typing.js\");\nvar __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_utils_js__WEBPACK_IMPORTED_MODULE_0__, _info_js__WEBPACK_IMPORTED_MODULE_2__, _services_messages_js__WEBPACK_IMPORTED_MODULE_3__, _services_typing__WEBPACK_IMPORTED_MODULE_4__]);\n([_utils_js__WEBPACK_IMPORTED_MODULE_0__, _info_js__WEBPACK_IMPORTED_MODULE_2__, _services_messages_js__WEBPACK_IMPORTED_MODULE_3__, _services_typing__WEBPACK_IMPORTED_MODULE_4__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);\n\n\n\n\n\n\nQuill.register('modules/emoji', QuillEmoji);\n\nlet submit = () => {};\nlet toggle = () => {};\nlet quillFocus = () => {};\n\nconst send = () => submit();\nconst toggleToolbar = () => toggle();\nconst focus = () => quillFocus();\n\nfunction initQuill() {\n  const quill = new Quill('#input', {\n    theme: 'snow',\n    modules: {\n      toolbar: [['bold', 'italic', 'underline', 'strike', 'link'], ['emoji'], [{ list: 'ordered' }, { list: 'bullet' }], ['blockquote', 'code', 'code-block'], ['clean']].flat(),\n      'emoji-toolbar': true,\n      'emoji-shortname': true,\n      keyboard: {\n        bindings: {\n          submit: {\n            key: 'enter',\n            handler() {\n              if (navigator.userAgentData.mobile) {\n                return true;\n              }\n              submit();\n              return false;\n            },\n          },\n        },\n      },\n    },\n  });\n\n  quill.focus();\n  quillFocus = () => quill.focus();\n\n  submit = () => {\n    (0,_services_messages_js__WEBPACK_IMPORTED_MODULE_3__.send)((0,_formatter_js__WEBPACK_IMPORTED_MODULE_1__.build)(quill.getContents()));\n    setTimeout(() => {\n      document.getElementById('scroll-stop').scrollIntoView();\n    }, 1);\n    quill.setContents([]);\n    quill.focus();\n  };\n  let visible = true;\n  toggle = () => {\n    if (visible) {\n      document.getElementsByClassName('ql-toolbar')[0].style = 'display: none;';\n    } else {\n      document.getElementsByClassName('ql-toolbar')[0].style = '';\n    }\n    visible = !visible;\n    quill.focus();\n  };\n}\n\nconst Input = () => {\n  const input = (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);\n  (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => initQuill(), []);\n  (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => toggleToolbar(), []);\n  (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {\n    input.current.addEventListener('keydown', _services_typing__WEBPACK_IMPORTED_MODULE_4__.notifyTyping);\n    return () => input.current.removeEventListener('keydown', _services_typing__WEBPACK_IMPORTED_MODULE_4__.notifyTyping);\n  }, []);\n  return _utils_js__WEBPACK_IMPORTED_MODULE_0__.html`\n    <div class=\"input-container\" onclick=${focus} >\n      <div id=\"input\" ref=${input}></div>\n      <div class='actionbar'>\n        <${_info_js__WEBPACK_IMPORTED_MODULE_2__.Info} />\n        <div class='action' onclick=${toggleToolbar}>\n          <i class=\"fa-solid fa-paragraph\"></i>\n        </div>\n        <div class='space'></div>\n        <div class='action green' onclick=${send}>\n          <i class=\"fa-solid fa-paper-plane\" />\n        </div>\n      </div>\n    </div>     \n  `;\n};\n\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } });\n\n//# sourceURL=webpack://quack/./src/js/components/input.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"play\": () => (/* binding */ play)\n/* harmony export */ });\nconst audio = new Audio('/assets/sound.mp3');\naudio.volume = 0.5;\nconst play = () => {\n  if (audio.paused) {\n    audio.currentTime = 0;\n    audio.play();\n  }\n};\n\n\n//# sourceURL=webpack://quack/./src/js/services/sound.js?");

/***/ }),

/***/ "./src/js/services/typing.js":
/*!***********************************!*\
  !*** ./src/js/services/typing.js ***!
  \***********************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
